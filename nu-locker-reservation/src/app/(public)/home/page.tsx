    ...
    <div className="min-h-screen relative">
      ...
      <div className="max-w-6xl mx-auto mb-12">
        <div className="text-center mb-6">
          ...
          {userData ? (
            <h2 className="text-xl font-semibold pt-10">Welcome, {userData.firstName}!</h2>
          ) : (
            <div className="text-xl pt-10">
              <p>
                Please <a href="/login" className="text-blue-500">log in</a> to access more features.
              </p>
            </div>
          )}
        </div>
          ...
          {lockerTypes.map((locker, index) => (
            ...
            >
              <CardHeader className="p-6 pb-0">
                <CardTitle className="text-xl font-semibold">{locker.title}</CardTitle>
