...
const Popover = dynamic(() => import('@headlessui/react').then((mod) => mod.Popover), { ssr: false })
const PopoverButton = dynamic(() => import('@headlessui/react').then((mod) => mod.PopoverButton), { ssr: false })
const PopoverGroup = dynamic(() => import('@headlessui/react').then((mod) => mod.PopoverGroup), { ssr: false })
const PopoverPanel = dynamic(() => import('@headlessui/react').then((mod) => mod.PopoverPanel), { ssr: false })
  ...
  return (
    <header className="bg-white">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <div className="hidden lg:flex lg:flex-3 lg:justify-end">
              ...
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="-mx-3">
                  ...
                  <DisclosurePanel className="mt-2 space-y-2">
                    {[...lockers, ...callsToAction].map((item) => (
                      <DisclosureButton
                        key={item.name}
                        as="a"
                        href={item.href}
